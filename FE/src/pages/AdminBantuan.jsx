    ...
    <AdminLayout>
      <div className="animate-fade-in space-y-10 pb-20">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-green-50 to-white dark:from-gray-900 dark:to-gray-900 rounded-[40px] p-10 border border-green-100 dark:border-gray-800">
          <HelpCircle className="absolute -right-10 -bottom-10 w-64 h-64 text-[#2d5a1e]/10 dark:text-green-900/20" />
          <div className="relative z-10">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-3">Admin &gt; Bantuan</p>
        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="relative group">
            <FileText className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#2d5a1e]" />
            <input 
              type="text" 
              placeholder="Cari topik bantuan atau kata kunci..." 
              className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 focus:border-[#2d5a1e] rounded-2xl pl-14 pr-6 py-4 text-sm font-medium focus:outline-none transition-all shadow-sm"
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: Shield, label: 'Etika & Privasi', desc: 'Kebijakan privasi dan perlindungan data pribadi.', color: 'text-[#2d5a1e]', bg: 'bg-[#2d5a1e]/5 dark:bg-green-900/20' },
          ].map((cat, i) => (
            <div key={i} className="bg-white dark:bg-gray-900 p-8 rounded-[32px] border border-gray-200 dark:border-gray-800 hover:border-[#2d5a1e]/30 transition-all group">
              <div className={`w-14 h-14 rounded-2xl ${cat.bg} flex items-center justify-center ${cat.color} mb-6`}>
                <cat.icon className="w-7 h-7" />
              </div>
              <h3 className="text-lg font-black text-gray-900 dark:text-white mb-2 group-hover:text-[#2d5a1e] transition-colors">{cat.label}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-[32px] border border-gray-200 dark:border-gray-800 text-center">
              <div className="w-14 h-14 rounded-2xl bg-green-50 dark:bg-green-900/20 flex items-center justify-center text-[#2d5a1e] mx-auto mb-6">
              ...
              <p className="text-sm font-bold text-[#2d5a1e] dark:text-green-400">support@laporinaja.id</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-[32px] border border-gray-200 dark:border-gray-800 text-center">
              ...
              <p className="text-sm font-bold text-[#2d5a1e] dark:text-green-400">+62 812 3456 7890</p>
            </div>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-[#2d5a1e] to-[#1a4d2e] p-10 rounded-[40px] shadow-xl shadow-green-900/20 relative overflow-hidden">
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-4">
              <Link to="/admin/dashboard" className="bg-white text-[#2d5a1e] px-8 py-4 rounded-xl text-sm font-black hover:bg-green-50 transition-all active:scale-95">
                Ke Dashboard
              </Link>
              <Link to="/admin/pengaturan" className="border-2 border-white text-white px-8 py-4 rounded-xl text-sm font-bold hover:bg-white/10 transition-all active:scale-95">
                Panduan User
              </Link>
            </div>
          </div>
